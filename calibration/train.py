...
def get_args():
    ...
    parser.add_argument('-o', '--output-file', default='new_parameters.json', help='File to store updated parameters, after training.')
...
def main():
    ...
    metric.save_to_config(args.output_file, comment)
