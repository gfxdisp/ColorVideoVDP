...
def simple_video_example( metric_class = pycvvdp.cvvdp, device=None ):
    ...
    print( 'Quality for static noise: {:.3f} JOD (took {:.4f} secs to compute)'.format(Q_JOD_static, tst_time) )
    res.append( ('Static noise', Q_JOD_static, tst_time))
    ...
    res.append( ('Dynamic noise', Q_JOD_dynamic, tst_time))

    return res

if __name__ == '__main__':
    simple_video_example( )