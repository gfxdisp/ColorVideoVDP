...
class video_source_array( video_source_dm ):
    ...
    def get_test_frame( self, frame_no, device, colorspace ):
        return self._get_frame(self.test_video, frame_no, device, colorspace, dm=self.test_dm )

    def get_reference_frame( self, frame_no, device, colorspace ):
        return self._get_frame(self.reference_video, frame_no, device, colorspace, dm=self.reference_dm )

    def _get_frame( self, from_array, frame_no, device, colorspace, dm=None ):        
